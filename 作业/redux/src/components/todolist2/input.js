...
import {tabinputChangeAction,tablistAddAction} from "../../actions/actionsCreator"
class InputTwo extends React.Component{
    ...
    handleChange(params,e){
        ...
        store.dispatch(tabinputChangeAction(value,params));
    }
    ...
    handleSubmit(e){
       e.stopPropagation();
        ...
        store.dispatch(tablistAddAction(time));
    }
    handleUpdate(){
